...
blob = glob(sequence)
current_used_onshore_cases = [ 'Paper_wind_2' ,'Paper_wind_2_landscapes' ,'Paper_wind_3' ,'Paper_wind_4' , 'S2_Expansive_noForest_IA1000_OA800_scenicness_threshold6', 'S2_Expansive_IA800_OA600']
# ofpv_cases = ['paper_SQR30','paper_SQR10','paper_SQR5','paper_SQR15','paper_SQR20','paper_SQR25','paper_SQR35','paper_SQR40']
ofpv_cases =['paper_SQR25', 'paper_SQR20']
for path in blob:
...
with open(json_path, 'r') as file:
    ...
    content['renewables']['openfield_pv']['nestor_ee_case'] = value[3]
    print('cases considered: ', content['renewables']['offshore']['nestor_ee_case'], content['renewables']['onshore']['nestor_ee_case'], content['renewables']['openfield_pv']['nestor_ee_case'] )
